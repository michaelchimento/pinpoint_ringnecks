...
data_dir_csv = "/home/michael/pinpoint_ringnecks/data/"
data_dir_video_frame = "/home/michael/pinpoint_ringnecks/video_frame_data/"
...
def create_csv(data_filepath):
    with open(data_filepath, "a+") as savefile: # open data file in append mode
        ...
        header = "population,room,time,id,id_prob,x,y,orientation,area\n"
    ...
    for directory in parent_directories:
        ...
        for folder in child_directories:
            if folder not in already_processed:
                ...
                try:
                    decode(folder, data_filepath, video_filepath, video_frame_filepath, tags, population,room)
